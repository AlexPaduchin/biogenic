...
const N = () => (
  <div>
    ...
    <div>
      {`
Это элемент 2 периода V A группы.Электронная конфигурация атома азота  1s22s22p3.
...
`}
    ...
    <div>
      {`
При обычных условиях азот химически инертен.Простое вещество азот(N2) -
основной компонент воздуха: его массовая доля 78 %.Из - за химической инертности азота
 ...
 бобовых растений и пурпурных и синезеленых водорослей, а также  во время грозы(N2 + O2= 2NO).
 `}
    </div>
    <div>
...
`}
  ...
  кирпичиков живого организма содержат азот в основном составе аминогрупп – NH2.
  `}
    </div>
    <div>
      {`
...
незаменимую роль  в процессах биологического окисления и фотосинтеза. `}
      ...
      <li>{` 4) Аммиак - летучее водородное соединение азота(NH3).Аммиак -
...
цикла и преобразуется  печенью в карбамид(мочевину(NH2)2 CO).
